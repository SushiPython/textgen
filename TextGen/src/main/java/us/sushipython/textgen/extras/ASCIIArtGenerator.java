package us.sushipython.textgen.extras;
...
public class ASCIIArtGenerator {
     ...
     * @return
     */
    private StringBuilder printTextArt(String artText, int textHeight, ASCIIArtFont fontType, String artSymbol) throws Exception {
     ...
     * @return
     */
    public StringBuilder printTextArt(String artText, int textHeight) throws Exception {
        StringBuilder data = printTextArt(artText, textHeight, ASCIIArtFont.ART_FONT_DIALOG, DEFAULT_ART_SYMBOL);
        return data;
    }
